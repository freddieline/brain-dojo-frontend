...
const SequenceTile: React.FC<InputProps> =({id, src, show, highlight, animate, incorrectlyGuessed}) => {
  ...
  return <div key={id} className={"flip-card w-110 mr-2 mb-2 "+ hiddenClass + animateClass}>
          <div className="flip-card-inner ">
            <div className={"flip-card-front border-4 "+ highlightClass + wrongClass}>
            </div>
            <div className={"flip-card-back border-4 relative "+ highlightClass + wrongClass}>
