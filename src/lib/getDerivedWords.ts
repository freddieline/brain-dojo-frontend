export function findDerivedWords(inputString: string, wordList: string[]): Set<string> {
    // Helper function to generate permutations recursively
    function permute(chars: string[], prefix: string = "", results: Set<string> = new Set(), minLength: number = 4): Set<string> {
