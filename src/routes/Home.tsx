	...
	return (
		<Layout>
      	...
      	<img className=" object-cover" src="babel.png" alt="Tower of Babel" />
			...
			<p className="text-lg  mt-5 mb-5">I've always been interested in learning new bits of knowledge from a range of topics. Hope you enjoy the quizzes I've created below :-)</p>
