  ...
  return (
    <Layout size={Size.small}>
      <div className="flex flex-col">
        ...
        <Link
          to="/memory-games/sequence"
          className="no-underline text-black hover:underline decoration-2"
        >
          <h3 className="text-xl mt-3">Memorise the sequence</h3>
        </Link>
        ...
        <Link
          to="/memory-games/association"
          className="no-underline text-black hover:underline"
        >
          <h3 className="text-xl mt-4">Memorise the capital cities</h3>
        </Link>
